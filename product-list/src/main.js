...
function Standalone() {
    ...
    return (_jsxs("div", { style: { padding: 20 }, children: [_jsx(ProductList, { products: demoProducts, onSelectProduct: (id) => setSelected(id) }), selected && _jsxs("div", { style: { marginTop: 20 }, children: ["Selected product id: ", selected] })] }));
}
