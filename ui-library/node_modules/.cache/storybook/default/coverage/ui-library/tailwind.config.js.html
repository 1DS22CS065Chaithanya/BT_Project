...
<head>
    <title>Code coverage report for ui-library/tailwind.config.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">ui-library</a> tailwind.config.js</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >    "./.storybook/**/*.{js,ts,jsx,tsx}",</span>
